/*
 *Author:* -
 *Description:* Maximum weight base in matroid intersection  $O (r^2n(O1+O2))$,
  where r is the rank of the basis, and n is the size of the ground set,
  O1 is the cost of Oracle query in the first matroid, and O2
  the cost of Oracle query in second matroid.
 *Status:* Not tested
*/
template<
